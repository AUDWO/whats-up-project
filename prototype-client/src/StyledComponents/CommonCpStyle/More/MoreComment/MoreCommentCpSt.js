...
export const MoreCommentWrapper = styled.div`
  width: 100%;
  height: auto;
  display: flex;
...
export const MoreCommentContentsWrapper = styled.div`
  display: flex;
  flex-direction: column;
  width: 700px;
  height: auto;
...
export const MoreCommentTitle = styled.div`
  width: 100%;
  font-size: 20px;
  font-weight: 500;
  border: none;
  margin-bottom: 20px;
`;
export const MoreCommnetInputWrapper = styled.div`
  display: flex;
  align-items: center;
  padding: 10px;
  width: 100%;
...
export const MoreCommentInputIcon = styled(BiPencil)`
  font-size: 25px;
  margin-right: 20px;
`;
export const MoreCommentInput = styled.textarea`
  width: 600px;
  height: 30px;
  font-size: 20px;
